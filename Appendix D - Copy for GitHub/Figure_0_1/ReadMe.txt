Steps to produce Figure 0.1 in Appendix D (important - must complete steps in the order listed)
...
3. Run the script "Frequency_matching_curve.m" to produce the plots in Figure 0.1 (left panel) 
   - output: (a) left panel of Figure 0.1 in Appendix D

4. To generate the right panel of Figure 0.1, run the script "Period_curve.m"
	- NOTE: this script takes several minutes to run
	- output: (a) right panel of Figure 0.1 in Appendix D