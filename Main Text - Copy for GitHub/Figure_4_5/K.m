...
%system
f_var = @(t,u) pi/12*[(u(2)+mu*(u(1)-(4/3)*u(1)^3)+B); ...
                      (-(24/tau)^2*u(1)+B*u(2)); ...
                      (mu-4*mu*u(1)^2)*u(3)+(1)*u(5); ...
                      (mu-4*mu*u(1)^2)*u(4)+(1)*u(6); ...
                      (-(24/tau)^2)*u(3)+(B)*u(5); ...
                      (-(24/tau)^2)*u(4)+(B)*u(6)];
...
for i=1:length(t)
    ...
    %do it (compute coefficients for x^2*x)
    temp_x_cubed = 0;
    for k=2
        for j=0:k
    ...
    %store it
    comp_coeff_x(3,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's (for m=2)
beta_2 = [comp_coeff_x(3,:); comp_coeff_y(3,:)];
...
for i=1:length(t)
    ...
    %store it
    comp_coeff_x(4,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's (for m=2)
beta_3 = [comp_coeff_x(4,:); comp_coeff_y(4,:)];
...
for i=1:length(t)
    ...
    %store it
    comp_coeff_x(5,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's (for m=2)
beta_4 = [comp_coeff_x(5,:); comp_coeff_y(5,:)];
...
for i=1:length(t)
    ...
    %store it
    comp_coeff_x(6,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's (for m=2)
beta_5 = [comp_coeff_x(6,:); comp_coeff_y(6,:)];
...
for i=1:length(t)
    ...
    %store it
    comp_coeff_x(7,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's
beta_6 = [comp_coeff_x(7,:); comp_coeff_y(7,:)];
...
for i=1:length(t)
    ...
    %store it
    comp_coeff_x(8,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's
beta_7 = [comp_coeff_x(8,:); comp_coeff_y(8,:)];
...
for i=1:length(t)
    ...
    %store it
    comp_coeff_x(9,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's
beta_8 = [comp_coeff_x(9,:); comp_coeff_y(9,:)];
...
for i=1:length(t)
    ...
    %store it
    comp_coeff_x(10,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's
beta_9 = [comp_coeff_x(10,:); comp_coeff_y(10,:)];
...
for i=1:length(t)
    ...
    %store it
    comp_coeff_x(11,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's
beta_10 = [comp_coeff_x(11,:); comp_coeff_y(11,:)];
...
for i=1:length(t)
    ...
    %store it
    comp_coeff_x(12,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's
beta_11 = [comp_coeff_x(12,:); comp_coeff_y(12,:)];
...
for i=1:length(t)
    ...
    %store it
    comp_coeff_x(13,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's
beta_12 = [comp_coeff_x(13,:); comp_coeff_y(13,:)];
...
for i=1:length(t)
    ...
    %store it
    comp_coeff_x(14,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's
beta_13 = [comp_coeff_x(14,:); comp_coeff_y(14,:)];
...
for i=1:length(t)
    ...
    %store it
    comp_coeff_x(15,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's
beta_14 = [comp_coeff_x(15,:); comp_coeff_y(15,:)];
...
for i=1:length(t)
    ...
    %store it
    comp_coeff_x(16,i) = -(4/3)*mu*(pi/12)*temp_x_cubed;
    
end

%beta's
beta_15 = [comp_coeff_x(16,:); comp_coeff_y(16,:)];
...
figure(1)
hold on
plot(t/Tmax,K_1(1,:),'r','LineWidth',2)
plot(t/Tmax,K_5(1,:),'g','LineWidth',2)
plot(t/Tmax,K_10(1,:),'b','LineWidth',2)
plot(t/Tmax,K_15(1,:),'m','LineWidth',2)
title('Kn')
box on
axis square
set(gca,'fontsize',15)
...
save('K0_circadian.mat','K_0')
save('K1_circadian.mat','K_1')
save('K2_circadian.mat','K_2')
save('K3_circadian.mat','K_3')
save('K4_circadian.mat','K_4')
save('K5_circadian.mat','K_5')
save('K6_circadian.mat','K_6')
save('K7_circadian.mat','K_7')
save('K8_circadian.mat','K_8')
save('K9_circadian.mat','K_9')
save('K10_circadian.mat','K_10')
save('K11_circadian.mat','K_11')
save('K12_circadian.mat','K_12')
save('K13_circadian.mat','K_13')
save('K14_circadian.mat','K_14')
save('K15_circadian.mat','K_15')
