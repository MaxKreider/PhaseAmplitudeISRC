Steps to produce Figure 4.2 (important - must complete steps in the order listed)
...
3. Run the script "Plot.m" to produce the plots in Figure 4.2 
   - output: (a) plots in Figure 4.2
	     (b) L2 error measure E_delta