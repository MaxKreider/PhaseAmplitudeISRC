...
%function
F = @(t,u) [u(1)-u(1)^3-u(2)+eps; u(1)+eps];

%solve it
x0 = [-0.785781525641688   1.301404835817183];
...
%beta's (for m=2)
beta_3 = 1*[comp_coeff_x(4,:); comp_coeff_y(4,:)];
...
%beta's (for m=2)
beta_4 = 1*[comp_coeff_x(5,:); comp_coeff_y(5,:)];
...
%beta's (for m=2)
beta_5 = 1*[comp_coeff_x(6,:); comp_coeff_y(6,:)];
...
%beta's
beta_6 = 1*[comp_coeff_x(7,:); comp_coeff_y(7,:)];
...
%beta's
beta_7 = 1*[comp_coeff_x(8,:); comp_coeff_y(8,:)];
...
%beta's
beta_8 = 1*[comp_coeff_x(9,:); comp_coeff_y(9,:)];
...
%beta's
beta_9 = 1*[comp_coeff_x(10,:); comp_coeff_y(10,:)];
...
%beta's
beta_10 = 1*[comp_coeff_x(11,:); comp_coeff_y(11,:)];
...
%beta's
beta_11 = 1*[comp_coeff_x(12,:); comp_coeff_y(12,:)];
...
%beta's
beta_12 = 1*[comp_coeff_x(13,:); comp_coeff_y(13,:)];
...
%beta's
beta_13 = 1*[comp_coeff_x(14,:); comp_coeff_y(14,:)];
...
%beta's
beta_14 = 1*[comp_coeff_x(15,:); comp_coeff_y(15,:)];
...
%beta's
beta_15 = 1*[comp_coeff_x(16,:); comp_coeff_y(16,:)];
...
save('K0_vdp_2.mat','K_0')
save('K1_vdp_2.mat','K_1')
save('K2_vdp_2.mat','K_2')
save('K3_vdp_2.mat','K_3')
save('K4_vdp_2.mat','K_4')
save('K5_vdp_2.mat','K_5')
save('K6_vdp_2.mat','K_6')
save('K7_vdp_2.mat','K_7')
save('K8_vdp_2.mat','K_8')
save('K9_vdp_2.mat','K_9')
save('K10_vdp_2.mat','K_10')
save('K11_vdp_2.mat','K_11')
save('K12_vdp_2.mat','K_12')
save('K13_vdp_2.mat','K_13')
save('K14_vdp_2.mat','K_14')
save('K15_vdp_2.mat','K_15')
