...
%timing factor so the oscillators have the same period
fac = 1/0.993064415014497;

%define order of Taylor expansion
L = 16;

%Jacobian
Jac = @(t,u) 1*[fac-3*u(1)^2, -fac; fac, 0];
...
%function
F = @(t,u) fac*[u(1)-u(1)^3-u(2)+eps; u(1)+eps];
...
%system
f_var = @(t,u) fac*[u(1)-u(1)^3-u(2)+eps; ...
                u(1)+eps; ...
                (1-3*u(1)^2)*u(3)-u(5); ...
                (1-3*u(1)^2)*u(4)-u(6); ...
                u(3); ...
